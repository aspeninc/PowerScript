...
Begin Dialog REMOTELINEFLT 30,60,217,120, "Remote Line Fault"
  ...
  CheckBox 48,47,150,11,"Percent of the relay line Z", .CheckBox6_Zbase
  ...
  CheckBox 10,101,86,11,"Clear previous results", .CheckBox5_clear
  PushButton 106,99,54,13,"Simulate", .Button1
  CancelButton 167,99,38,13
End Dialog
...
Sub initDlg()
  ...
  While Not EOF(1)
    ...
    elseif 1=InStr(1,aLine,"CheckBox5_Ainc=") Then
      If Mid(aLine,Len("CheckBox5_Ainc=")+1,99) = "1" Then dlg.CheckBox5_Ainc = true Else dlg.CheckBox5_Ainc = true 
    elseif 1=InStr(1,aLine,"CheckBox6_Zbase=") Then
      If Mid(aLine,Len("CheckBox6_Zbase=")+1,99) = "1" Then dlg.CheckBox6_Zbase = true Else CheckBox6_Zbase = true 
    elseif 1=InStr(1,aLine,"CheckBox5_Clear=") Then
      If Mid(aLine,Len("CheckBox5_Clear=")+1,99) = "1" Then dlg.CheckBox5_Clear = true Else CheckBox5_Clear = true 
    End If
  Wend
  Close #1
  cont:
